...
public class UnitTwoSolution {
	...
	public static void main(String[] args) {
		List<Person> persons = new ArrayList<Person>(Arrays.asList(
				new Person("Sachin", "Wakle", 27),
				new Person("Sachith", "R.", 25),
				new Person("Shiven", "P.", 26)));
	 ...
	 * 
	 * @param persons
	 * @param predicate - functional interface, available as out of the box which contain test method which returns boolean type 
	 * @param consumer - functional interface, available as out of the box which contain accept method which takes single argument
	 *                   and returns nothing
	 */
